 ...
 */
public class NetPriv extends Netflix{
    String payment;
    int durasi, harga, nominalp, totalharga;
    
    public NetPriv(String email, String password, String profil, int pin){
    ...
    public void akun(){
        System.out.println("==============================");
        System.out.println("     Akun Netflix Private     ");
        System.out.println("==============================");
        super.akun();
    }
    @Override
