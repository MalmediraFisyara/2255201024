 ...
 */
public class NetSemiPriv extends Netflix{
    String payment;
    int durasi, harga, nominalp, totalharga;
    
    public NetSemiPriv(String email, String password, String profil, int pin){
    ...
    public void akun(){
        System.out.println("==============================");
        System.out.println("   Akun Netflix Semi Private  ");
        System.out.println("==============================");
        super.akun();
}
    @Override
